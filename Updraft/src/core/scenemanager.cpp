...
osg::GraphicsContext::Traits* SceneManager::createGraphicsTraits(int x, int y, int w, int h, 
...
osgQt::GraphicsWindowQt* SceneManager::createGraphicsWindow(osg::GraphicsContext::Traits* traits) {

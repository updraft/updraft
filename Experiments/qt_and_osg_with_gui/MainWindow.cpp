...
const char PATH[] = "c:/Users/Tom/Desktop/osg_32debug/data/cessna.osgt";
   ...
   : QMainWindow(), sceneViewer(NULL)
{
   ...
   sceneViewer = new CSceneViewer(threadingModel, createCamera(0,0,100,100), osgDB::readNodeFile(PATH));
